...
Razor's uses a specially modified fork of PHPUnit that don't need PEAR. This eliminates PHPUnit's legendary installation problems for Mac and Windows users. Zero dependencies also means you can check Razor into your team's version control system, confident that it will run on any machine.
