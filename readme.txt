...
State of the art cross-platform automated unit testing for WordPress plugins, on Linux, Windows, and Mac OS, from the <a href="https://code.google.com/p/buddypress-media/">BP-Media Team</a>.
...
Razor's specially modified forks of PHPUnit and JSUnit that don't use PEAR, eliminating PHPUnit's legendary installation problems for Mac and Windows users. Zero dependencies also means you can confidently check Razor into your team's version control system, knowing it will run on any machine.
