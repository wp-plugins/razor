 ...
 */
 ...
 /**
 * Plugin Name: Razor
 * Plugin URI:  https://code.google.com/p/wp-razor/
 * Description: State of the art cross-platform unit testing for WordPress plugins
 * Author:      The BP-Media Team
 * Author URI:  https://code.google.com/p/buddypress-media/people/list/
 * Version:     3.2
 */
    ...
    if( !defined( 'ABSPATH' ) && !(php_sapi_name() == 'cli' && empty($_SERVER['REMOTE_ADDR'])) ){
	    ...
	    if( !defined( 'ABSPATH' ) ){
		    ...
		    // include in the main script file.
			    ...
			    // Upgrade the WordPress installation if necessary. This is used to test if a plugin will
	    ...
	    // ==============================================================
		    ...
		    require_once( dirname(__FILE__) . '/testlib/php/class.profiler.php');
		    require_once( dirname(__FILE__) . '/testlib/php/class.utils.debug.php');
		    require_once( dirname(__FILE__) . '/testlib/php/class.utils.debug.diff.php');
