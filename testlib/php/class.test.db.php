<?php
/**
 * RAZOR UNIT TEST DATABASE CLASS
 * A simplifed, global-free and DEFINE-free version of the wpdb database class. It can be run without loading the WordPress core
 *
 * @version 3.1
 * @since 0.1
 * @author original version from @link http://wordpress.org
 * @package Razor
 * @subpackage Core
 * @license GPL v2.0
...
class RAZ_test_db {
	 ...
	 */
	function RAZ_test_db( $dbuser, $dbpassword, $dbname, $dbhost ) {
